...
# Paths & Variables
reads_dir='/NGS_variant_discovery/reads'
raw_reads1=${reads_dir}'/SRR5439568_1.fastq'
raw_reads2=${reads_dir}'/SRR5439568_2.fastq'
alignment_dir='/NGS_variant_discovery/2nd_pipeline/alignment'
variants_dir='/NGS_variant_discovery/2nd_pipeline/variants'
...
reference_genome_dir='/NGS_variant_discovery/reference/Homo_sapiens/GATK/GRCh38/Sequence/WholeGenomeFasta'
